...
less dmel-all-chromosome-r6.36.fasta.gz.2 
q 

#Name the file 
all_chromosomes="dmel-all-chromosome-r6.36.fasta.gz.2"
less $all_chromosomes
q 

#Checksum 
md5sum $all_chromosomes
#output: fbd2855a20c3610050ff2496dd975821  dmel-all-chromosome-r6.36.fasta.gz.2 
